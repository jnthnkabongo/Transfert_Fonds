                    ...
                    <div class="card-body">
                        <div class="row ">
                            ...
                            <div class="col-xs-4 col-md-4 justify-content-end">
                                <button type="button" class="btn btn-primary btn-md" data-bs-toggle="modal" data-bs-target="#basicModal">Ajouter une devise</button>
                            </div>
                        </div>
    ...
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title">Ajout d'une Dévise</h5>
